...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/19 11:30:49 by akhanye           #+#    #+#             */
/*   Updated: 2017/10/19 11:30:55 by akhanye          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_and(int pc, t_arena *arena, t_champ *champ)
{
	...
	if (inititate_wait(champ, arena, 5, "AND"))
		return ;
	champ->run = NO;
	pc++;
	ft_bzero(size, 3);
	...
	show_trace("\nAND played by : ", arena, champ, SHOW_CHAMP);
}
